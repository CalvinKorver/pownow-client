...
export const StyledMenu = styled(Menu)`height: 125px !important; margin-top: 20px; padding-left: 5%`;
export const MobileStyledMenu = styled(Menu)`height: 60px !important; padding: 5px !important`;
